...
:doit
if /i "%1#" == "--libs#"    echo -LC:/Program Files (x86)/utag/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/Program Files (x86)/utag/include/taglib
if /i "%1#" == "--version#" echo 1.11.1
if /i "%1#" == "--prefix#"  echo C:/Program Files (x86)/utag
